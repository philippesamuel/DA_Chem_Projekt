...
- [ ] LF mit mean und alle hochkorrelierte Variablen rausgetrennt.

([part2_variable_reduction_teil2.py]

[part2_variablen_reduction]"part2_variablen_reduction")
---
> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5OTQ2NjM2OCwtODEzMjgwOTkwLC0yMD
